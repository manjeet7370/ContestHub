  ...
  <footer className="bg-slate-950 border-t border-slate-800">
    <div className="max-w-4xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-1">
        <a href="/" className="text-xs text-slate-500 hover:text-slate-100 px-2.5 py-1 rounded-md hover:bg-slate-800 transition-colors duration-150">
          Home
        </a>
        <a href="/contest" className="text-xs text-slate-500 hover:text-slate-100 px-2.5 py-1 rounded-md hover:bg-slate-800 transition-colors duration-150">
          Contests
        </a>
        <a href="/submission" className="text-xs text-slate-500 hover:text-slate-100 px-2.5 py-1 rounded-md hover:bg-slate-800 transition-colors duration-150">
          Submissions
        </a>
        <a
          href="https://github.com/manjeet7370"
